...
public class BuscaCliente extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		if(nome.contains("João")){
		
			Cliente u1 = new Cliente("João Mario","15 98874585","Rua Banana");
			Cliente u2 = new Cliente("João Alberto","15 96584778","Vila Rosana");
			Cliente u3 = new Cliente("João Henrique","15 9652365","rua alberto");
			
			clientes.add(u1);
			clientes.add(u2);
			clientes.add(u3);
		} else if(nome.contains("Maria")){
			Cliente u1 = new Cliente("Maria Paula","15 88785489","Rua secundária");
